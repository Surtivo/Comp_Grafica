...
void Desenha(void)
{
    ...
    glPushMatrix();
    glRotated(cam_X, 1, 0, 0);  // Recebe o vetor unitátio do eixo que o objeto irá rodar
    glRotated(cam_Y, 0, 1, 0);  // Recebe o vetor unitátio do eixo que o objeto irá rodar
